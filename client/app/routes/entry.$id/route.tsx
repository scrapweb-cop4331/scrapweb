...
export default function MediaDetailRoute() {
  ...
  const handleAboutMouseDown = (e: React.MouseEvent) => {
    ...
    const onMove = (ev: MouseEvent) => {
      ...
      setAboutPos({
        x: aboutDragRef.current.startX + dx,
        y: aboutDragRef.current.startY + dy,
      });
    };
    const onUp = () => {
  ...
  */
  ...
  const titleText = editMode
    ? saveStatus === "saving"
      ? `* ${titleBase} - Saving...`
      : saveStatus === "saved"
        ? `${titleBase} - saved at ${savedTime}`
        : saveStatus === "error"
          ? `* ${titleBase} - Save failed`
          : titleBase
    : titleBase;
    ...
    >
          ...
          {editingDate && (
            ...
            >
              ...
              >
                <button
                  onClick={() => {
                    if (dateInput) setEntryDate(dateInput);
            ...
            {editMode ? (
              ...
              >
                {text ? (
                  ...
                  <em>No notes yet. Switch to Edit mode to add some.</em>
                )}
              </div>
            )}
          </Frame>
      ...
      */}
      ...
      <div
        ...
        onDoubleClick={() => {
          if (!aboutWasDragged.current) navigate("/about");
        }}
        style={{
          position: "absolute",
          top: aboutPos.y,
      ...
      {showDeleteConfirm && (
        ...
        >
          <Modal
            ...
            title="Delete Entry"
            titleBarOptions={
              <TitleBar.Close onClick={() => setShowDeleteConfirm(false)} />
            }
            style={{ width: "300px" }}
          >
            <div
            ...
            >
              ...
              >
                ...
                <div style={{ fontSize: "12px", lineHeight: 1.5 }}>
                  ...
                  <div style={{ color: "#555", marginTop: "4px" }}>
                    This will permanently remove the text, photo, and audio.
              ...
              >
                <Button
                  ...
                  disabled={deleting}
                  style={{ minWidth: "75px", fontSize: "12px" }}
                >
                  {deleting ? "..." : "Delete"}
                </Button>
                <Button
